...
{
	m_Box.Y += static_cast<int>(m_Direction.Y) * static_cast<int>(m_Speed) * GAME_ENGINE->GetGameSpeed();
	m_Box.X += static_cast<int>(m_Direction.X) * static_cast<int>(m_Speed) * GAME_ENGINE->GetGameSpeed();
